...
var ClassTable = newClassTableTable("", "class_table", "")

type classTableTable struct {
	sqlite.Table
...
type ClassTableTable struct {
	...
	EXCLUDED classTableTable
}

// AS creates new ClassTableTable with assigned alias
func (a ClassTableTable) AS(alias string) *ClassTableTable {
	return newClassTableTable(a.SchemaName(), a.TableName(), alias)
}

// Schema creates new ClassTableTable with assigned schema name
func (a ClassTableTable) FromSchema(schemaName string) *ClassTableTable {
	return newClassTableTable(schemaName, a.TableName(), a.Alias())
}

// WithPrefix creates new ClassTableTable with assigned table prefix
func (a ClassTableTable) WithPrefix(prefix string) *ClassTableTable {
	return newClassTableTable(a.SchemaName(), prefix+a.TableName(), a.TableName())
}

// WithSuffix creates new ClassTableTable with assigned table suffix
func (a ClassTableTable) WithSuffix(suffix string) *ClassTableTable {
	return newClassTableTable(a.SchemaName(), a.TableName()+suffix, a.TableName())
}

func newClassTableTable(schemaName, tableName, alias string) *ClassTableTable {
	return &ClassTableTable{
		classTableTable: newClassTableTableImpl(schemaName, tableName, alias),
		EXCLUDED:        newClassTableTableImpl("", "excluded", ""),
	}
}

func newClassTableTableImpl(schemaName, tableName, alias string) classTableTable {
	var (
